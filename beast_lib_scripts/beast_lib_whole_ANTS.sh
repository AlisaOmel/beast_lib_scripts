...
mkdir -p /home/aomelche/library_NFBS_ben/NFBS/transform_files
...
antsApplyTransforms --default-value 0 --dimensionality 3 --input ${LibPath}/masks/${fname}.nii --input-image-type 0 --interpolation NearestNeighbor --output ${LibPath}/masks/${fname}_warped.nii --reference-image $MNIHeadTemplatePATH --transform ${LibPath}/transform_files/${fname}_transform3Warp.nii.gz --transform ${LibPath}/transform_files/${fname}_transform2Affine.mat --transform ${LibPath}/transform_files/${fname}_transform1Rigid.mat --transform ${LibPath}/transform_files/${fname}_transform0DerivedInitialMovingTranslation.mat

#antsApplyTransforms --default-value 0 --dimensionality 3 --input /home/aomelche/library_NFBS_ben/NFBS/masks/test4.nii --input-image-type 0 --interpolation NearestNeighbor --output /home/aomelche/library_NFBS_ben/NFBS/masks/test4_warped.nii --reference-image /usr/share/fsl/5.0/data/standard/MNI152_T1_1mm.nii.gz --transform /home/aomelche/library_NFBS_ben/NFBS/transform_files/test4_transform3Warp.nii.gz --transform /home/aomelche/library_NFBS_ben/NFBS/transform_files/test4_transform2Affine.mat --transform /home/aomelche/library_NFBS_ben/NFBS/transform_files/test4_transform1Rigid.mat --transform /home/aomelche/library_NFBS_ben/NFBS/transform_files/test4_transform0DerivedInitialMovingTranslation.mat

echo Sending to MNC...
/opt/minc-itk4/bin/nii2mnc ${file}_Warped.nii ${file}.mnc
/opt/minc-itk4/bin/nii2mnc ${LibPath}/masks/${fname}_warped.nii ${LibPath}/masks/${fname}.mnc
...
mv ${file}.nii ${LibPath}/stx/intermediate_files
